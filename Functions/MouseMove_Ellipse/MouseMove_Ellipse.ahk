...
;========================================================================
; 
; Function:     MouseMove_Ellipse
; Description:  Moves mouse using an ellipse instead of a straight line
; URL (+info):  http://bit.ly/YNKpPy
;
; Last Update:  06/March/2013 17:00 BRT
;
...
MouseMove_Ellipse( pos_X1 , pos_Y1 , param_Options = "" )
{
  ...
  loc_B := Abs(pos_X0-pos_X1) ; Width
  loc_A := Abs(pos_Y0-pos_Y1) ; Height
  ...
  MouseMove, %pos_X1%, %pos_Y1%, 0 ; (sometimes loop would end with mouse more than "loc_Speed pixels" from pos_X1,pos_Y1)

  If ( loc_Block )
    BlockInput, Off

  SetMouseDelay, %loc_MDelay% ; Reset mouse delay
